...
namespace Stock {
    ...
    public partial class StockDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(int ProductCode, string ProductName, bool ProductStatus, double ProductPrice, System.DateTime Date) {
...
namespace Stock.StockDataSet2TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductCode] = @Original_ProductCode) AND (" +
                "[ProductName] = @Original_ProductName) AND ([ProductStatus] = @Original_ProductS" +
                "tatus) AND ([ProductPrice] = @Original_ProductPrice) AND ([Date] = @Original_Dat" +
                "e))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductCode], [ProductName], [ProductStatus], [ProductPrice], [Date]) VALUES (@ProductCode, @ProductName, @ProductStatus, @ProductPrice, @Date);
SELECT ProductCode, ProductName, ProductStatus, ProductPrice, Date FROM Products WHERE (ProductCode = @ProductCode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductCode] = @ProductCode, [ProductName] = @ProductName, [ProductStatus] = @ProductStatus, [ProductPrice] = @ProductPrice, [Date] = @Date WHERE (([ProductCode] = @Original_ProductCode) AND ([ProductName] = @Original_ProductName) AND ([ProductStatus] = @Original_ProductStatus) AND ([ProductPrice] = @Original_ProductPrice) AND ([Date] = @Original_Date));
SELECT ProductCode, ProductName, ProductStatus, ProductPrice, Date FROM Products WHERE (ProductCode = @ProductCode)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductCode, ProductName, ProductStatus, ProductPrice, Date FROM dbo.Produ" +
                "cts";
        ...
        public virtual int Fill(StockDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual StockDataSet2.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StockDataSet2.ProductsDataTable dataTable = new StockDataSet2.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StockDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductCode, string Original_ProductName, bool Original_ProductStatus, double Original_ProductPrice, System.DateTime Original_Date) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((bool)(Original_ProductStatus));
            this.Adapter.DeleteCommand.Parameters[3].Value = ((double)(Original_ProductPrice));
        ...
        public virtual int Insert(int ProductCode, string ProductName, bool ProductStatus, double ProductPrice, System.DateTime Date) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((bool)(ProductStatus));
        ...
        public virtual int Update(int ProductCode, string ProductName, bool ProductStatus, double ProductPrice, System.DateTime Date, int Original_ProductCode, string Original_ProductName, bool Original_ProductStatus, double Original_ProductPrice, System.DateTime Original_Date) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((bool)(ProductStatus));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((bool)(Original_ProductStatus));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, bool ProductStatus, double ProductPrice, System.DateTime Date, int Original_ProductCode, string Original_ProductName, bool Original_ProductStatus, double Original_ProductPrice, System.DateTime Original_Date) {
            return this.Update(Original_ProductCode, ProductName, ProductStatus, ProductPrice, Date, Original_ProductCode, Original_ProductName, Original_ProductStatus, Original_ProductPrice, Original_Date);
        }
    }

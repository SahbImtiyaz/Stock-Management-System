...
namespace Stock.StockDataSet4TableAdapters {
    ...
    public partial class StockTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Stock] WHERE (([ProductCode] = @Original_ProductCode) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_TransDate = 1 AND [TransDate] IS NULL) OR ([TransDate] = @Original_TransDate)) AND ([Quantity] = @Original_Quantity))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Stock] SET [ProductCode] = @ProductCode, [ProductName] = @ProductName, [TransDate] = @TransDate, [Quantity] = @Quantity WHERE (([ProductCode] = @Original_ProductCode) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_TransDate = 1 AND [TransDate] IS NULL) OR ([TransDate] = @Original_TransDate)) AND ([Quantity] = @Original_Quantity));
SELECT ProductCode, ProductName, TransDate, Quantity FROM Stock WHERE (ProductCode = @ProductCode)";
        ...
        public virtual int Fill(StockDataSet4.StockDataTable dataTable) {
        ...
        public virtual StockDataSet4.StockDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StockDataSet4.StockDataTable dataTable = new StockDataSet4.StockDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StockDataSet4.StockDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductCode, string Original_ProductName, global::System.Nullable<global::System.DateTime> Original_TransDate, double Original_Quantity) {
        ...
        public virtual int Insert(int ProductCode, string ProductName, global::System.Nullable<global::System.DateTime> TransDate, double Quantity) {
        ...
        public virtual int Update(int ProductCode, string ProductName, global::System.Nullable<global::System.DateTime> TransDate, double Quantity, int Original_ProductCode, string Original_ProductName, global::System.Nullable<global::System.DateTime> Original_TransDate, double Original_Quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<global::System.DateTime> TransDate, double Quantity, int Original_ProductCode, string Original_ProductName, global::System.Nullable<global::System.DateTime> Original_TransDate, double Original_Quantity) {
